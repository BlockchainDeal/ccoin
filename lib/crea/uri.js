/**
 * uri.js - creativecoin uri parsing for ccoin
...
/**
 * Represents a creativecoin URI.
 * @alias module:crea.URI
 * @constructor
...
URI.prototype.fromString = function fromString(str, network) {
  ...
  assert(str.length > 8, 'Not a creativecoin URI.');

  const prefix = str.substring(0, 8);

  assert(prefix === 'creativecoin:', 'Not a creativecoin URI.');
...
URI.prototype.toString = function toString() {
  ...
  if (this.amount !== -1)
    query.push(`amount=${Amount.crea(this.amount)}`);
