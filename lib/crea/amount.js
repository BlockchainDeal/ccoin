/*!
 * amount.js - amount object for ccoin
...
/**
 * Represents a creativecoin amount (satoshis internally).
 * @alias module:crea.Amount
 * @constructor
...
/**
 * Get mcrea string or value.
 * @param {Boolean?} num
 * @returns {String|Amount}
 */

Amount.prototype.toMCREA = function toMCREA(num) {
  return Amount.encode(this.value, 5, num);
};

/**
 * Get crea string or value.
 * @param {Boolean?} num
 * @returns {String|Amount}
 */

Amount.prototype.toCREA = function toCREA(num) {
...
Amount.prototype.to = function to(unit, num) {
  switch (unit) {
    ...
    case 'mcrea':
      return this.toMCREA(num);
    case 'crea':
      return this.toCREA(num);
  }
  throw new Error(`Unknown unit "${unit}".`);
};

/**
 * Convert amount to creativecoin string.
 * @returns {String}
 */
...
/**
 * Inject properties from mcrea.
 * @private
 * @param {Number|String} value
 * @returns {Amount}
 */

Amount.prototype.fromMCREA = function fromMCREA(value) {
  this.value = Amount.decode(value, 5);
  return this;
};

/**
 * Inject properties from crea.
 * @private
 * @param {Number|String} value
 * @returns {Amount}
 */

Amount.prototype.fromCREA = function fromCREA(value) {
...
/**
 * Instantiate amount from mcrea.
 * @param {Number|String} value
 * @returns {Amount}
 */

Amount.fromMCREA = function fromMCREA(value) {
  return new Amount().fromMCREA(value);
};

/**
 * Instantiate amount from crea.
 * @param {Number|String} value
 * @returns {Amount}
 */

Amount.fromCREA = function fromCREA(value) {
  return new Amount().fromCREA(value);
};
...
/**
 * Safely convert satoshis to a CREA string.
 * This function explicitly avoids any
 * floating point arithmetic.
 * @param {Amount} value - Satoshis.
 * @returns {String} CREA string.
 */

Amount.crea = function crea(value, num) {
...
/**
 * Safely convert a CREA string to satoshis.
 * @param {String} str - CREA
...
/**
 * Safely convert a CREA string to satoshis.
 * @param {String|Number} value - CREA
 * @param {Number} exp - Exponent.
 * @returns {Amount} Satoshis.
 * @throws on parse error
 */
