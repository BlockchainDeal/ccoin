/*!
 * mtx.js - mutable transaction object for ccoin
 ...
 * @see https://github.com/creativecoin/bips/blob/master/bip-0069.mediawiki
 */
 ...
 * @see creativecoin/src/wallet/wallet.cpp
 */
...
function FundingError(msg, available, required) {
  ...
  if (available != null) {
    this.message += ` (available=${Amount.crea(available)},`;
    this.message += ` required=${Amount.crea(required)})`;
