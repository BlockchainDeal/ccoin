/*!
 * compress.js - coin compressor for ccoin
 ...
 * the fact that many creativecoin values are divisible by 10.
 * @see https://github.com/creasuite/cread/blob/master/blockchain/compress.go
 * @param {Amount} value
 * @returns {Number}
 */
